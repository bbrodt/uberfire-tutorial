...
public class DashboardView extends Composite implements DashboardPresenter.View {
    ...
    @Override
    public void addProject(final Project project, final String tasksCreated, final String tasksDone) {
        ListGroup projectGroup = GWT.create(ListGroup.class);

        projectGroup.add(createListGroupItem(ListGroupItemType.INFO, project.getName().toUpperCase(), null));
    ...
    private ListGroupItem createListGroupItem(final ListGroupItemType type, final String text, final String number) {
